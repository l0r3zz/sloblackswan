...
[SLOs can't catch a Black Swan](https://github.com/l0r3zz/sloblackswan/blob/main/SLOBLACKSWAN-v0.13/SLOBLACKSWAN-v0.13.md)

### Grab the PDF!

[SLOs can't catch a Black Swan (PDF)](https://github.com/l0r3zz/sloblackswan/blob/main/SLOBLACKSWAN-v0.13/SLOBLACKSWAN-v0.13.pdf)
...
### EXTRA BONUS !!!
There is a notebookLM notebook with a version of the book loaded that you can interact with. 
